import { formatAmerican, formatMoney, parlayOdds, potentialPayout } from '../lib/odds.js'

export default function ParlaySummary({ legs, stake, expectedLegs }) {
  ...
  return (
    <div className="stat-tiles">
      <div className="tile">
        ...
        <div className="value">{legCount}{expectedLegs ? <span className="muted"> / {expectedLegs}</span> : null}</div>
